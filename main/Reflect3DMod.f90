...
CONTAINS
  ...
  SUBROUTINE Reflect3D( is, HS, BotTop, nBdry, z_xx, z_xy, z_yy, kappa_xx, kappa_xy, kappa_yy, RefC, &
			Npts, ray3D, iSegz, iSegx, iSegy )
    ...
    CALL EvaluateSSP3D( ray3D( is1 )%x, c, cimag, gradc, cxx, cyy, czz, cxy, cxz, cyz, rho, freq, 'TAB', iSegz, iSegx, iSegy )
    ray3D( is1 )%c         = c
