MODULE WriteRay
  ...
  USE sspMod
  IMPLICIT NONE
  INTEGER, PRIVATE :: MaxNRayPoints = 50000   ! this is the maximum length of the ray vector that is written out

CONTAINS

  SUBROUTINE WriteRay2D( alpha0, Nsteps1, ray2D )
  ...
  SUBROUTINE WriteRay3D( alpha0, beta0, Nsteps1, xs, ray2D, ray3D )
